...
import static org.neo4j.kernel.store.format.dsl.FieldTypes.single_byte;
...
public class PrimitiveFieldTest
{
    ...
    @Test
    public void shouldHandlePrimitiveTypes() throws Exception
    {
        // Given
        ...
        format.defineItem( "MyItem" )
            .field( "aLong",      fixed_signed_int64() )
            .field( "anInt",      fixed_signed_int32() )
            .field( "aShort",     fixed_signed_int16() )
            .field( "singleByte", single_byte() )
        ;
